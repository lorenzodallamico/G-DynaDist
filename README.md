...
| [**Paper**](https://www.nature.com/articles/s41467-024-54280-4) | [**Documentation**](https://lorenzodallamico.github.io/G-DynaDist/intro.html) |
...
<p align="center">
  <img src="logo.png" alt="Description" width="200"/>
</p>
...
We also created a dedicated [**documentation**](https://lorenzodallamico.github.io/G-DynaDist/intro.html) for the use of the package. 



> **NOTES**
> 
> * The codes in this repository can be used to reproduce the results contained in the paper. We recommend to use the new version for practical use, since they are more stable, more intuitive, and better documented.
> * When trying to reproduce the results in the paper, one might have some issues of compatibility with the EDRep package. This is a minor issue given by the fact that some greek letters were spelled differently in an earlier version, for instance, `η` became `eta`. These issues do not occur in the `pip` version of the codes.
...
* `Data/Shuffled`: the data that should be inside of it are generated with the notebook named `Shuffle`. Once compiled, it generates a sequence of folders, each one containing several shuffles of every graph in the `Graphs` folder for all the shuffling types considered in the paper.
